...
//    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request != null) {
            ...
            String url = RealCustomerDAO.checkParameter(request);
            if (url.length() != 0) {
                ...
                if (type.equalsIgnoreCase("real")) {
                    ...
                    try {
                        int result = RealCustomerDAO.insertRealCustomer(realCustomer);
                        if (result != -1) {
                    ...
                    try {
                        int result = LegalCustomerDAO.insertLegalCustomer(legalCustomer);
                        if (result != -1) {
